...
committee_totals_instance = CommitteeTotals.from_json(json)
# print the JSON string representation of the object
print(CommitteeTotals.to_json())

# convert the object into a dict
committee_totals_dict = committee_totals_instance.to_dict()
# create an instance of CommitteeTotals from a dict
committee_totals_from_dict = CommitteeTotals.from_dict(committee_totals_dict)
```
