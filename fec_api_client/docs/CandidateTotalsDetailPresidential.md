...
candidate_totals_detail_presidential_instance = CandidateTotalsDetailPresidential.from_json(json)
# print the JSON string representation of the object
print(CandidateTotalsDetailPresidential.to_json())

# convert the object into a dict
candidate_totals_detail_presidential_dict = candidate_totals_detail_presidential_instance.to_dict()
# create an instance of CandidateTotalsDetailPresidential from a dict
candidate_totals_detail_presidential_from_dict = CandidateTotalsDetailPresidential.from_dict(candidate_totals_detail_presidential_dict)
```
