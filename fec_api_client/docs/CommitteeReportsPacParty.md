...
committee_reports_pac_party_instance = CommitteeReportsPacParty.from_json(json)
# print the JSON string representation of the object
print(CommitteeReportsPacParty.to_json())

# convert the object into a dict
committee_reports_pac_party_dict = committee_reports_pac_party_instance.to_dict()
# create an instance of CommitteeReportsPacParty from a dict
committee_reports_pac_party_from_dict = CommitteeReportsPacParty.from_dict(committee_reports_pac_party_dict)
```
