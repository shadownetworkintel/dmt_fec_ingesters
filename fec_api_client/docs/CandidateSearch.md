...
**principal_committees** | [**List[PrincipalCommittee]**](PrincipalCommittee.md) |  | [optional] 
...
candidate_search_instance = CandidateSearch.from_json(json)
# print the JSON string representation of the object
print(CandidateSearch.to_json())

# convert the object into a dict
candidate_search_dict = candidate_search_instance.to_dict()
# create an instance of CandidateSearch from a dict
candidate_search_from_dict = CandidateSearch.from_dict(candidate_search_dict)
```
