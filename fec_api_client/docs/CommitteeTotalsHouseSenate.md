...
committee_totals_house_senate_instance = CommitteeTotalsHouseSenate.from_json(json)
# print the JSON string representation of the object
print(CommitteeTotalsHouseSenate.to_json())

# convert the object into a dict
committee_totals_house_senate_dict = committee_totals_house_senate_instance.to_dict()
# create an instance of CommitteeTotalsHouseSenate from a dict
committee_totals_house_senate_from_dict = CommitteeTotalsHouseSenate.from_dict(committee_totals_house_senate_dict)
```
