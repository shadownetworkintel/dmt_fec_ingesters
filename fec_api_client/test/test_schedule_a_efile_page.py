...
class TestScheduleAEfilePage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ScheduleAEfilePage:
        """Test ScheduleAEfilePage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduleAEfilePage`
        """
        model = ScheduleAEfilePage()
        if include_optional:
            return ScheduleAEfilePage(
                pagination = openapi_client.models.offset_info.OffsetInfo(
                    ...
                    per_page = 56, ),
                results = [
                    openapi_client.models.schedule_a_efile.ScheduleAEfile(
                        amendment_indicator = '', 
