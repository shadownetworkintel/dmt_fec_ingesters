...
class TestPresidentialSummaryPage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PresidentialSummaryPage:
        """Test PresidentialSummaryPage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PresidentialSummaryPage`
        """
        model = PresidentialSummaryPage()
        if include_optional:
            return PresidentialSummaryPage(
                pagination = openapi_client.models.offset_info.OffsetInfo(
                    ...
                    per_page = 56, ),
                results = [
                    openapi_client.models.presidential_summary.PresidentialSummary(
