...
class TestCommitteeTotalsPerCyclePage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CommitteeTotalsPerCyclePage:
        """Test CommitteeTotalsPerCyclePage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommitteeTotalsPerCyclePage`
        """
        model = CommitteeTotalsPerCyclePage()
        if include_optional:
            return CommitteeTotalsPerCyclePage(
                pagination = openapi_client.models.offset_info.OffsetInfo(
                    ...
                    per_page = 56, ),
                results = [
                    openapi_client.models.committee_totals_per_cycle.CommitteeTotalsPerCycle(
