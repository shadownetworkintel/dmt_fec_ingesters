...
class TestCommitteeReportsIEOnly(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CommitteeReportsIEOnly:
        """Test CommitteeReportsIEOnly
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommitteeReportsIEOnly`
        """
        model = CommitteeReportsIEOnly()
        if include_optional:
