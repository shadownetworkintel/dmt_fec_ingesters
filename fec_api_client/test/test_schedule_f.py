...
class TestScheduleF(unittest.TestCase):
    """ScheduleF unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleF:
        """Test ScheduleF
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduleF`
        """
        model = ScheduleF()
        if include_optional:
            return ScheduleF(
