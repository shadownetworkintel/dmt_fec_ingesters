...
class TestCommitteeReportsPacPartyPage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CommitteeReportsPacPartyPage:
        """Test CommitteeReportsPacPartyPage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommitteeReportsPacPartyPage`
        """
        model = CommitteeReportsPacPartyPage()
        if include_optional:
            return CommitteeReportsPacPartyPage(
                pagination = openapi_client.models.offset_info.OffsetInfo(
                    ...
                    per_page = 56, ),
                results = [
                    openapi_client.models.committee_reports_pac_party.CommitteeReportsPacParty(
