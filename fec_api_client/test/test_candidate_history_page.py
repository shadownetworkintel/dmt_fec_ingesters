...
class TestCandidateHistoryPage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CandidateHistoryPage:
        """Test CandidateHistoryPage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CandidateHistoryPage`
        """
        model = CandidateHistoryPage()
        if include_optional:
            return CandidateHistoryPage(
                pagination = openapi_client.models.offset_info.OffsetInfo(
                    ...
                    per_page = 56, ),
                results = [
                    openapi_client.models.candidate_history.CandidateHistory(
                        active_through = 56, 
                        address_city = '', 
                        address_state = '', 
                        address_street_1 = '', 
