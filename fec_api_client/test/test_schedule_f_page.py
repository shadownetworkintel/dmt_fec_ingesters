...
class TestScheduleFPage(unittest.TestCase):
    """ScheduleFPage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleFPage:
        """Test ScheduleFPage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduleFPage`
        """
        model = ScheduleFPage()
        if include_optional:
            return ScheduleFPage(
                pagination = openapi_client.models.offset_info.OffsetInfo(
                    ...
                    per_page = 56, ),
                results = [
                    openapi_client.models.schedule_f.ScheduleF(
                        action_code = '', 
                        action_code_full = '', 
                        ...
                        schedule_type_full = '', 
                        sub_id = '', 
                        subordinate_committee = openapi_client.models.committee_history.CommitteeHistory(
                            affiliated_committee_name = '', 
                            city = '', 
                            committee_id = '', 
                            committee_type = '', 
