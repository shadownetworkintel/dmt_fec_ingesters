...
class TestCommitteeTotalsHouseSenatePage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CommitteeTotalsHouseSenatePage:
        """Test CommitteeTotalsHouseSenatePage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommitteeTotalsHouseSenatePage`
        """
        model = CommitteeTotalsHouseSenatePage()
        if include_optional:
            return CommitteeTotalsHouseSenatePage(
                pagination = openapi_client.models.offset_info.OffsetInfo(
                    ...
                    per_page = 56, ),
                results = [
                    openapi_client.models.committee_totals_house_senate.CommitteeTotalsHouseSenate(
