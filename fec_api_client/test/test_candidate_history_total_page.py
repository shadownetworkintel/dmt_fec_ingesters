...
class TestCandidateHistoryTotalPage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CandidateHistoryTotalPage:
        """Test CandidateHistoryTotalPage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CandidateHistoryTotalPage`
        """
        model = CandidateHistoryTotalPage()
        if include_optional:
            return CandidateHistoryTotalPage(
                pagination = openapi_client.models.offset_info.OffsetInfo(
                    ...
                    per_page = 56, ),
                results = [
                    openapi_client.models.candidate_history_total.CandidateHistoryTotal(
                        active_through = 56, 
                        address_city = '', 
                        address_state = '', 
                        address_street_1 = '', 
                        ...
                        flags = openapi_client.models.flags.flags(), 
