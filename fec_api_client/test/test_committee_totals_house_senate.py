...
class TestCommitteeTotalsHouseSenate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CommitteeTotalsHouseSenate:
        """Test CommitteeTotalsHouseSenate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommitteeTotalsHouseSenate`
        """
        model = CommitteeTotalsHouseSenate()
        if include_optional:
