...
class TestScheduleH4Page(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ScheduleH4Page:
        """Test ScheduleH4Page
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduleH4Page`
        """
        model = ScheduleH4Page()
        if include_optional:
            return ScheduleH4Page(
                pagination = openapi_client.models.seek_info.SeekInfo(
                    ...
                    per_page = 56, ),
                results = [
                    openapi_client.models.schedule_h4.ScheduleH4(
                        activity_or_event = '', 
