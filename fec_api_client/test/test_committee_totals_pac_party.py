...
class TestCommitteeTotalsPacParty(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CommitteeTotalsPacParty:
        """Test CommitteeTotalsPacParty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommitteeTotalsPacParty`
        """
        model = CommitteeTotalsPacParty()
        if include_optional:
