...
class TestScheduleH4Efile(unittest.TestCase):
    """ScheduleH4Efile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleH4Efile:
        """Test ScheduleH4Efile
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduleH4Efile`
        """
        model = ScheduleH4Efile()
        if include_optional:
            return ScheduleH4Efile(
                activity_or_event = '',
