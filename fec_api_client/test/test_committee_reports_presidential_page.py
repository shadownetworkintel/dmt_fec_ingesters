...
class TestCommitteeReportsPresidentialPage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CommitteeReportsPresidentialPage:
        """Test CommitteeReportsPresidentialPage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommitteeReportsPresidentialPage`
        """
        model = CommitteeReportsPresidentialPage()
        if include_optional:
            return CommitteeReportsPresidentialPage(
                pagination = openapi_client.models.offset_info.OffsetInfo(
                    ...
                    per_page = 56, ),
                results = [
                    openapi_client.models.committee_reports_presidential.CommitteeReportsPresidential(
                        amendment_chain = [
                            1.337
                            ], 
                        amendment_indicator = '', 
