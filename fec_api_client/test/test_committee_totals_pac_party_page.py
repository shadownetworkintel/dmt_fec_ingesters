...
class TestCommitteeTotalsPacPartyPage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CommitteeTotalsPacPartyPage:
        """Test CommitteeTotalsPacPartyPage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommitteeTotalsPacPartyPage`
        """
        model = CommitteeTotalsPacPartyPage()
        if include_optional:
            return CommitteeTotalsPacPartyPage(
                pagination = openapi_client.models.offset_info.OffsetInfo(
                    ...
                    per_page = 56, ),
                results = [
                    openapi_client.models.committee_totals_pac_party.CommitteeTotalsPacParty(
