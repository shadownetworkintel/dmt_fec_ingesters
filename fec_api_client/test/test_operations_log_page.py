...
class TestOperationsLogPage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OperationsLogPage:
        """Test OperationsLogPage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OperationsLogPage`
        """
        model = OperationsLogPage()
        if include_optional:
            return OperationsLogPage(
                pagination = openapi_client.models.offset_info.OffsetInfo(
                    ...
                    per_page = 56, ),
                results = [
                    openapi_client.models.operations_log.OperationsLog(
                        amendment_indicator = '', 
