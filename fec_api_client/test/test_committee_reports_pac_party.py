...
class TestCommitteeReportsPacParty(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CommitteeReportsPacParty:
        """Test CommitteeReportsPacParty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommitteeReportsPacParty`
        """
        model = CommitteeReportsPacParty()
        if include_optional:
