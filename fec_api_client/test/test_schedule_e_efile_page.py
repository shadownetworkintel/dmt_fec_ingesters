...
class TestScheduleEEfilePage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ScheduleEEfilePage:
        """Test ScheduleEEfilePage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduleEEfilePage`
        """
        model = ScheduleEEfilePage()
        if include_optional:
            return ScheduleEEfilePage(
                pagination = openapi_client.models.offset_info.OffsetInfo(
                    ...
                    per_page = 56, ),
                results = [
                    openapi_client.models.schedule_e_efile.ScheduleEEfile(
                        amendment_indicator = '', 
