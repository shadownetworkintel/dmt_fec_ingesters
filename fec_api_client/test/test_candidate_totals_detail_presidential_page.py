...
class TestCandidateTotalsDetailPresidentialPage(unittest.TestCase):
    """CandidateTotalsDetailPresidentialPage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CandidateTotalsDetailPresidentialPage:
        """Test CandidateTotalsDetailPresidentialPage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CandidateTotalsDetailPresidentialPage`
        """
        model = CandidateTotalsDetailPresidentialPage()
        if include_optional:
            return CandidateTotalsDetailPresidentialPage(
                pagination = openapi_client.models.offset_info.OffsetInfo(
                    ...
                    per_page = 56, ),
                results = [
                    openapi_client.models.candidate_totals_detail_presidential.CandidateTotalsDetailPresidential(
    ...
    def testCandidateTotalsDetailPresidentialPage(self):
        """Test CandidateTotalsDetailPresidentialPage"""
