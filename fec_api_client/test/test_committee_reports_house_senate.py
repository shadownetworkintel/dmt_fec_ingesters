...
class TestCommitteeReportsHouseSenate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CommitteeReportsHouseSenate:
        """Test CommitteeReportsHouseSenate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommitteeReportsHouseSenate`
        """
        model = CommitteeReportsHouseSenate()
        if include_optional:
