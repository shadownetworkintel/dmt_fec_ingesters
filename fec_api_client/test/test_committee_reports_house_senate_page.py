...
class TestCommitteeReportsHouseSenatePage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CommitteeReportsHouseSenatePage:
        """Test CommitteeReportsHouseSenatePage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommitteeReportsHouseSenatePage`
        """
        model = CommitteeReportsHouseSenatePage()
        if include_optional:
            return CommitteeReportsHouseSenatePage(
                pagination = openapi_client.models.offset_info.OffsetInfo(
                    ...
                    per_page = 56, ),
                results = [
                    openapi_client.models.committee_reports_house_senate.CommitteeReportsHouseSenate(
