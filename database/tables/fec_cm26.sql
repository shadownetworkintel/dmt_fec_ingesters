...
CREATE TABLE fec_cm26 (
    ...
    cmte_st                 CHAR(2),
    cmte_zip                VARCHAR(10),
    cmte_dsgn               CHAR(1) CHECK (cmte_dsgn IN ('A', 'B', 'D', 'J', 'P', 'U')), -- Designation codes
    ...
    cmte_filing_freq        CHAR(1) CHECK (cmte_filing_freq IN ('A', 'M', 'Q', 'T', 'W', 'X', 'Y')), -- Filing frequency codes
