...
SELECT DISTINCT cmte_id, cmte_nm, cmte_tp, tres_nm, cmte_city, cmte_st
...
SELECT contributor_name, contributor_city, contributor_state, committee_id, committee_name, candidate_name, cmte_nm, cand_id, contribution_receipt_amount, contribution_receipt_date
